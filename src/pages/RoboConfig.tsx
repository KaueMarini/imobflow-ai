...
export default function RoboConfig() {
  ...
  const handleCreateAgent = async () => {
    ...
    try {
      ...
      console.log("Resposta COMPLETA do webhook criarInstancia:", JSON.stringify(rawResponse, null, 2));
      
      // O webhook pode retornar um array ou um objeto
      const dataWebhook = Array.isArray(rawResponse) ? rawResponse[0] : rawResponse;
      ...
      console.log("rawQr extraído:", rawQr);

      const qrUrl = normalizeQrCodeUrl(rawQr);
      
      console.log("QR Code URL final:", qrUrl);
